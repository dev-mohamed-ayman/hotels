                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('client_type') is-invalid @enderror" id="client_type"
                                    ...
                                    <option value="P2C"
                                        {{ old('client_type', $booking->customer->type == 'corporate' ? 'P2C' : '') == 'P2C' ? 'selected' : '' }}>
                                        {{ __('P2C (Corporate)') }}</option>
                                    <option value="P2P"
                                        {{ old('client_type', $booking->customer->type == 'individual' ? 'P2P' : '') == 'P2P' ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                class="form-control addition-amount" value="{{ $addition->amount }}"
                                                required />
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                class="form-control discount-amount" value="{{ $discount->amount }}"
                                                required />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">{{ __('Description') }}</label>
