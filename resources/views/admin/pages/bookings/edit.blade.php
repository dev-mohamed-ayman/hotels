                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('hotel_confirmation_number', $booking->hotel_confirmation_number) }}" />
                            ...
                            @foreach ($booking->rooms as $index => $room)
                                <div class="room-row mb-3 p-3 border rounded bg-light">
                                    ...
                                    <div class="row g-2 mt-2">
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label fw-semibold">{{ __('Guest Rate') }} <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" step="any"
                                                name="rooms[{{ $index }}][guest_rate]"
                                                class="form-control room-guest-rate"
                                                value="{{ $room->price + $room->margin }}" min="0" required />
                                        </div>
                                        <div class="col-md-2">
                                    ...
                                    <div class="row g-2 mt-2">
                                        ...
                                        <div class="col-md-3">
                                            <label
                                                class="form-label fw-semibold text-info">{{ __('Child Guest Rate') }}</label>
                                            <input type="number" step="any"
                                                name="rooms[{{ $index }}][child_guest_rate]"
                                                class="form-control room-child-guest-rate"
                                                value="{{ ($room->child_price ?? 0) + ($room->child_margin ?? 0) }}"
                                                min="0" />
                                        </div>
                                        <div class="col-md-3">
                                            <label
