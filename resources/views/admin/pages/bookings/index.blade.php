                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="sort_by" class="form-select">
                                                        ...
                                                        <option value="check_in" {{ request('sort_by') == 'check_in' ? 'selected' : '' }}>
                                                            {{ __('Check In') }}
                                                        </option>
                                                        <option value="check_out" {{ request('sort_by') == 'check_out' ? 'selected' : '' }}>
                                                            {{ __('Check Out') }}
                                                        </option>
                                                        <option value="total_amount" {{ request('sort_by') == 'total_amount' ? 'selected' : '' }}>
                                                            {{ __('Total Amount') }}
                                                        </option>
                                                        <option value="paid_amount" {{ request('sort_by') == 'paid_amount' ? 'selected' : '' }}>
                                                            {{ __('Paid Amount') }}
                                                        </option>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-nowrap py-2">
                                                                ...
                                                                @elseif ($booking->payment_status == 'paid')
                                                                    <span class="badge bg-success" title="{{ __('Paid') }}" style="font-size: 0.75rem;">
                                                                ...
                                                                @elseif ($booking->payment_status == 'revised')
                                                                    <span class="badge bg-info" title="{{ __('Revised') }}" style="font-size: 0.75rem;">
                                                        ...
                                                        <div class="modal fade" id="paymentModal{{ $booking->id }}" tabindex="-1">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('bookings.update-payment', $booking) }}" method="POST">
                                                                        @csrf
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                <label class="form-label">{{ __('Current Paid Amount') }}</label>
                                                                                <input type="text" class="form-control"
                                                                                    value="{{ $booking->paid_amount == 0
                                    ? ''
                                    : (fmod($booking->paid_amount, 1) == 0
                                        ? intval($booking->paid_amount)
                                        : number_format($booking->paid_amount, 2)) . ' ' . $booking->currency->symbol }}" readonly>
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    id="remaining{{ $booking->id }}" value="{{ $remaining == 0
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    <input type="number" step="0.01" class="form-control"
                                                                                        id="payment_amount{{ $booking->id }}" name="payment_amount"
