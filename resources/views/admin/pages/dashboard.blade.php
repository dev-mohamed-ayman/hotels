                                ...
                                <tbody>
                                    @foreach ($upcomingOptionDates as $booking)
                                        <tr>
                                            ...
                                            @include('admin.pages.bookings.partials.actions', ['idPrefix' => 'opt'])
                                        </tr>
                                        @include('admin.pages.bookings.partials.hotel-payment-modal', ['idPrefix' => 'opt'])
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($upcomingBookings as $booking)
                                        <tr>
                                            ...
                                            @include('admin.pages.bookings.partials.actions', ['idPrefix' => 'soon'])
                                        </tr>
                                        @include('admin.pages.bookings.partials.hotel-payment-modal', ['idPrefix' => 'soon'])
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
                            ...
                            <tbody>
                                @forelse ($recentBookings as $booking)
                                    <tr>
                                        ...
                                        @include('admin.pages.bookings.partials.actions', ['idPrefix' => 'recent'])
                                    </tr>

                                    @include('admin.pages.bookings.partials.hotel-payment-modal', ['idPrefix' => 'recent'])
                @empty
                    <tr>
