                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('phone_1') is-invalid @enderror"
                                    id="phone_1" name="phone_1" value="{{ old('phone_1') }}" required />
                                @error('phone_1')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <select class="form-select @error('source') is-invalid @enderror" id="source"
                                    ...
                                    <option value="phone" {{ old('source') == 'phone' ? 'selected' : '' }}>
                                        {{ __('Phone') }}</option>
                                    <option value="website" {{ old('source') == 'website' ? 'selected' : '' }}>
                                        {{ __('Website') }}</option>
                                    <option value="social_media" {{ old('source') == 'social_media' ? 'selected' : '' }}>
                                        {{ __('Social Media') }}</option>
                                    <option value="referral" {{ old('source') == 'referral' ? 'selected' : '' }}>
                                        {{ __('Referral') }}</option>
                                    <option value="direct_visit" {{ old('source') == 'direct_visit' ? 'selected' : '' }}>
                                ...
                                <select class="form-select select2 @error('hotels') is-invalid @enderror" id="hotels"
                                    ...
                                    @foreach ($hotels as $hotel)
                                        <option value="{{ $hotel->id }}"
                                            {{ in_array($hotel->id, old('hotels', [])) ? 'selected' : '' }}>
                                            {{ $hotel->name }}
                                        </option>
                                    @endforeach
                                </select>
